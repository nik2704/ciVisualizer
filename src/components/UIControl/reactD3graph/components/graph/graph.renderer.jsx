    ...
    if (!markerCache[key]) {
      ...
      markerCache[key] = (
        <defs>
          ...
          {/* CUSTOMIZATION : added some refs */}
          <Marker id={MARKERS.MARKER_GREEN_S} refX={small} fill="green" {...markerProps} />
          <Marker id={MARKERS.MARKER_ORANGE_S} refX={small} fill="orange" {...markerProps} />
          <Marker id={MARKERS.MARKER_RED_S} refX={small} fill="red" {...markerProps} />
          <Marker id={MARKERS.MARKER_GRAY_S} refX={small} fill="gray" {...markerProps} />

          <Marker id={MARKERS.MARKER_GREEN_SH} refX={small} fill="green" {...markerProps} />
          <Marker id={MARKERS.MARKER_ORANGE_SH} refX={small} fill="orange" {...markerProps} />
          <Marker id={MARKERS.MARKER_RED_SH} refX={small} fill="red" {...markerProps} />
          <Marker id={MARKERS.MARKER_GRAY_SH} refX={small} fill="gray" {...markerProps} />

          <Marker id={MARKERS.MARKER_GREEN_M} refX={medium} fill="green" {...markerProps} />
          <Marker id={MARKERS.MARKER_ORANGE_M} refX={medium} fill="orange" {...markerProps} />
          <Marker id={MARKERS.MARKER_RED_M} refX={medium} fill="red" {...markerProps} />
          <Marker id={MARKERS.MARKER_GRAY_M} refX={medium} fill={color} {...markerProps} />
          
          <Marker id={MARKERS.MARKER_GREEN_MH} refX={medium} fill="green" {...markerProps} />
          <Marker id={MARKERS.MARKER_ORANGE_MH} refX={medium} fill="orange" {...markerProps} />
          <Marker id={MARKERS.MARKER_RED_MH} refX={medium} fill="red" {...markerProps} />
          <Marker id={MARKERS.MARKER_GRAY_MH} refX={medium} fill="gray" {...markerProps} />

          <Marker id={MARKERS.MARKER_GREEN_L} refX={large} fill="green" {...markerProps} />
          <Marker id={MARKERS.MARKER_ORANGE_L} refX={large} fill="orange" {...markerProps} />
          <Marker id={MARKERS.MARKER_RED_L} refX={large} fill="red" {...markerProps} />
          <Marker id={MARKERS.MARKER_GRAY_L} refX={large} fill="gray" {...markerProps} />

          <Marker id={MARKERS.MARKER_GREEN_LH} refX={large} fill="green" {...markerProps} />
          <Marker id={MARKERS.MARKER_ORANGE_LH} refX={large} fill="orange" {...markerProps} />
          <Marker id={MARKERS.MARKER_RED_LH} refX={large} fill="red" {...markerProps} />
          <Marker id={MARKERS.MARKER_GRAY_LH} refX={large} fill="gray" {...markerProps} />
        </defs>
      );
    }
